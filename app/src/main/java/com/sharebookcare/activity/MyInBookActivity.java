...
import com.sharebookcare.adapter.MyInBookAdapter;
...
public class MyInBookActivity extends BaseActivity implements AllBookContract.View {

    private static final String TAG = MyInBookActivity.class.getSimpleName();

    private ListView bookRv;
    private MyInBookAdapter adapter;
    ...
    protected void initListener() {
        bookRv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(MyInBookActivity.this,DetailActivity.class);
...
//        presenter = new AllBookPresenter(this);
        getIntentData();
        adapter = new MyInBookAdapter(this);
